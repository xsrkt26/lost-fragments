...
func _get_hub_player(hub: Node) -> CharacterBody2D:
	...
	if hub_player == null:
		hub_player = _get_hub_player(hub)
	return hub_player
...
func test_hub_merchant_animation_follows_player_arrival_and_departure():
	...
	var merchant_sprite := hub.get_node_or_null("HubPageVisualRoot/HubArt/MerchantSprite") as AnimatedSprite2D
	...
	var room := hub.get_node_or_null("HubPageVisualRoot/HubArt/Room") as Sprite2D
...
func test_hub_dreamcatcher_is_stage_art_and_battle_entry_hotspot():
	...
	var net := hub.get_node_or_null("HubPageVisualRoot/HubArt/DreamcatcherNet") as Sprite2D
	assert_not_null(net)
	assert_not_null(net.texture)
	assert_eq(net.texture.resource_path, "res://assets/ui/battle/dreamcatchers/act_1_xiaomi.png")
...
func test_hub_zone_triggers_do_not_show_current_prompt_bubbles():
	...
	var speech_bubble := hub.get_node_or_null("HubPageVisualRoot/HubArt/SpeechBubble") as Sprite2D
	var speech_text := hub.get_node_or_null("HubPageVisualRoot/HubArt/SpeechText") as Label
...
func test_hub_scene_applies_stage_background_and_foreground():
	...
	var foreground := hub.get_node_or_null("HubPageVisualRoot/HubArt/Foreground") as Sprite2D
...
func test_hub_scene_uses_split_hub_art_without_composited_reference():
	...
	for node_path in [
		...
		"HubPageVisualRoot/HubArt/SpeechBubble",
	]:
	...
	var hub_player := _get_hub_player(hub)
	var dreamcatcher_net := hub.get_node_or_null("HubPageVisualRoot/HubArt/DreamcatcherNet") as Sprite2D
	var merchant_sprite := hub.get_node_or_null("HubPageVisualRoot/HubArt/MerchantSprite") as AnimatedSprite2D
	var speech_bubble_for_z := hub.get_node_or_null("HubPageVisualRoot/HubArt/SpeechBubble") as Sprite2D
	var room := hub.get_node_or_null("HubPageVisualRoot/HubArt/Room") as Sprite2D
