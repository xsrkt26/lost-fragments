...
@export_file("*.png") var intro_bag_frame_1_path := "res://assets/ui/battle/intro_bag_reveal/bag_reveal_01.png"
@export_file("*.png") var intro_bag_frame_2_path := "res://assets/ui/battle/intro_bag_reveal/bag_reveal_02.png"
@export_file("*.png") var intro_bag_frame_3_path := "res://assets/ui/battle/intro_bag_reveal/bag_reveal_03.png"
@export_file("*.png") var intro_bag_frame_4_path := "res://assets/ui/battle/intro_bag_reveal/bag_reveal_04.png"
@export_file("*.png") var intro_bag_frame_5_path := "res://assets/ui/battle/intro_bag_reveal/bag_reveal_05.png"
